...
const PremiumArticles = () => {
    ...
    useEffect(()=>{
        if (!isLoading) {
            const premiumArticles = premium.filter(article => article.isPremium == true);
              ...
              <div key={article._id} className="card bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                  ...
                  <div className="card-actions justify-end">
                    <div className="badge badge-outline">{article?.publisherName.label}</div>
                    <button className="badge badge-outline bg-cyan-500 text-white p-3">Details</button>
                  </div>
                </div>
              </div>
            ))}
